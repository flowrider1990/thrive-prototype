...
export function ThemeSwitch() {
  ...
  return (
    <button
      ...
      className="edge inline-flex items-center justify-center rounded-full border-line-strong p-1.5 text-muted transition-colors hover:border-muted hover:text-ink"
    >
